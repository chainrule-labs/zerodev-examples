...
import { getErc20Policy, getNativePolicy } from "./getPolicies.js";
import { erc20Abi, parseUnits } from "viem";
import { getSmartAccountAddress } from "./getCounterfactual.js";
				...
				callData: sessionKeyAccount.encodeCallData([
					{
						...
						data: encodeFunctionData({
							...
							args: [TEST_HOT_WALLET, parseUnits("0.02", 6)],
						}),
					},
				]),
			},
